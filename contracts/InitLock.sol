...
contract InitIssueAndLock is MultiSig{
  ...
  constructor(address _gt_contract, uint _unlock_block_number, address[] memory _addrs, uint[] memory _amounts, address[] memory _signers) MultiSig(_signers) public {
...
contract InitIssueAndLockFactory{
  ...
  function createIssueAndLock(address _gt_contract,
                             ...
                             address[] memory _signers) public returns(InitIssueAndLock){
